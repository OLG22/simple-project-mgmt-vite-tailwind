...
export default function AddCard() {
  return (
    <>
    <section className="">
  <div className="px-4 mx-auto my-8 max-w-2xl lg:py-16 border bg-white border-gray-200 rounded-lg shadow-[5px_5px_10px_0px_rgba(0,0,0,0.3)]">
      <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">Ajouter un nouveau sujet</h2>
      <form action="#">
