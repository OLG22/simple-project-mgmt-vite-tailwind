...
export default function ConnexionModal() {
    ...
    **************************************************************************/
    ...
    return (
        <>
            <div id="connexion-modal-backdrop" tabIndex="-1" aria-hidden="true" className="fixed top-[41px] z-50 w-full h-full backdrop-blur flex justify-center items-center" onClick={() => toggleModals("close")}>
            </div >
